...
def plot_m_eos_val_on_kde(datafile, MCMC_distribution_file, name, N=1000):
    # Plot the heat and kde of the eos' radii distribution
    # Plot the mass radii curve for the global max values
    # Plot the true eos curve as well
    ...
    pl.plot(working_masses,working_radii,label="Highest Likelihood")
    ...
    for m in m_grid:
        try:
            ...
            continue
    pl.plot(working_masses,working_radii,label="True EOS")
